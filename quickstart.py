...
if __name__ == "__main__":
    ...
    dpt_dt = cli_args.dt
    dpt_tm = cli_args.tm
    psg_info_per_prnb = cli_args.ps

    num_trains_to_check = cli_args.num
    num_trains_to_check_start = cli_args.num_s
    want_reserve = cli_args.reserve

    srt = SRT(dpt_stn, arr_stn, dpt_dt, dpt_tm, psg_info_per_prnb, num_trains_to_check, num_trains_to_check_start, want_reserve)
